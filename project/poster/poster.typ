...
#let poster(
  ...
  set page(
    ...
    footer: [
      ...
      #block(
        ...
        radius: 10pt,
        [
          #text(font: "Courier", size: footer_url_font_size, footer_url, fill: white) 
          #h(1fr) 
          #text(size: footer_text_font_size, smallcaps(footer_text), fill: white) 
          #h(1fr) 
          #text(font: "Courier", size: footer_url_font_size, footer_email_ids, fill: white)
        ]
      )
    ]
  )
  ...
  show heading: it => locate(loc => {
    ...
    if it.level == 1 [
      ...
      #v(32pt, weak: true)
      #if it.numbering != none {
        numbering("1.a.", levels.at(0), deepest)
        h(7pt, weak: true)
      }
      #it.body
      #v(10pt, weak: true)
